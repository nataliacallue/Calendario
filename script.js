...
function clearActiveButtons(){
  document.querySelectorAll(".modal-body .btn").forEach(btn=>btn.classList.remove("active"));
}
...
document.getElementById("exportPDF").addEventListener("click",async()=>{
  ...
  const canvas=await html2canvas(container,{scale:2,useCORS:true,scrollY:-window.scrollY,windowWidth:document.documentElement.offsetWidth,windowHeight:document.documentElement.offsetHeight});
